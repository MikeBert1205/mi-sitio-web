...
<head>
  ...
  <link rel="stylesheet" href="estilosComunicacion.css" />
...
<body>
  ...
  <div class="gradient-div">
    ...
    <h3>
      Recuerda que siempre estamos a un clic de distancia, en nuestras redes
      sociales podrás encontrarnos.
    </h3>
  </div>
  ...
  <div class="container contenedor-redes mb-5">
    <div class="row cards">
      <div class="col-12 mt-4 col-md-6 col-lg-4">
        <div class="card">
          <div class="card-body d-flex flex-column justify-content-center align-items-center">
            <img src="./imagenes/logo-instagram.svg" alt="" />
            <p class="card-text text-center text-card">
              En nuestra página de Instagram podrás encontrar información
              relevante sobre el reciclaje y la sustentabilidad.
            </p>
      ...
      <div class="col-12 mt-4 col-md-6 col-lg-4">
        <div class="card">
          <div class="card-body d-flex flex-column justify-content-center align-items-center">
            <img src="./imagenes/logo-facebook.svg" alt="" />
            <p class="card-text text-center text-card">
              En nuestra página de Facebook podrás encontrar información
              relevante sobre el reciclaje y la sustentabilidad.
            </p>
            <img src="./imagenes/logo-reciclaje.svg" alt="" />
          </div>
      ...
      <div class="col-12 mt-4 col-md-6 col-lg-4">
        <div class="card">
          <div class="card-body d-flex flex-column justify-content-center align-items-center">
            <img src="./imagenes/logo-whats.svg" alt="" />
            <p class="card-text text-center text-card">
              En WhatsApp subimos diario contenido para comunicar a las
              personas la importancia del reciclaje.
            </p>
            <img src="./imagenes/logo-reciclaje.svg" alt="" />
          </div>
        </div>
    ...
    <div class="row justify-content-center mockup">
      <img src="./imagenes/mockupComunicacion.jpg" alt="mockupComunicacion" class="w-50 col-6 col-md-12 mt-4" />
    </div>
  </div>
